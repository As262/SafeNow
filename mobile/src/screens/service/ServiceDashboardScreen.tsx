...
const ServiceDashboardScreen: React.FC = () => {
  ...
  const renderRequestCard = (request: SOSRequest, isPending: boolean) => {
    ...
    return (
      <TouchableOpacity
        ...
        style={[
          ...
          !isPending && styles.requestCardAccepted,
        ]}
      ...
      >
        ...
        <View style={styles.requestHeader}>
          <View style={styles.requestUserInfo}>
            ...
            <TouchableOpacity
              ...
              onPress={() => callNumber(request.userId || '')}
            >
          ...
          <View style={[styles.typeBadge, { backgroundColor: serviceInfo.color + '30' }]}>
            <Text style={[styles.typeBadgeText, { color: serviceInfo.color }]}>{request.type}</Text>
          </View>
        </View>
        ...
        {!isPending && (
          <View style={styles.acceptedRow}>
            ...
            <Text style={styles.acceptedText}>You responded to this request</Text>
            <TouchableOpacity
            ...
            >
              <Navigation color={colors.primary[500]} size={18} />
            </TouchableOpacity>
          </View>
        )}
      </TouchableOpacity>
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          <View style={[styles.headerIcon, { backgroundColor: serviceInfo.color }]}>
            <ServiceIcon color="#fff" size={24} />
          </View>
          <View>
            <Text style={styles.headerTitle}>SafeNow {serviceInfo.name}</Text>
      ...
      >
        ...
        <View style={styles.statsGrid}>
          ...
          <View style={styles.statCard}>
            ...
            <Text style={styles.statSubtext}>Active responses</Text>
          </View>
          ...
          <View style={styles.statCard}>
            ...
            <Text style={styles.statValue}>{analytics?.averageResponseTime || '—'}</Text>
            <Text style={styles.statSubtext}>Target: &lt;10 min</Text>
          </View>
          ...
          <View style={styles.statCard}>
            ...
            <Text style={styles.statSubtext}>
              {serviceInfo.filterTypes ? serviceInfo.filterTypes[0] : 'All types'}
            </Text>
          </View>
        </View>
          ...
          {loading ? (
            ...
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptyText}>
                No pending {serviceInfo.filterTypes ? serviceInfo.filterTypes[0] : ''} requests
              </Text>
            </View>
          ) : (
        ...
        <View style={styles.userInfoCard}>
          ...
          <View style={styles.userInfoText}>
            <Text style={styles.userInfoName}>{user?.name || user?.service_id}</Text>
            <Text style={styles.userInfoRole}>{serviceInfo.name}</Text>
          </View>
        </View>
      </ScrollView>
    </View>
...
const styles = StyleSheet.create({
  ...
  requestCardAccepted: {
    borderColor: colors.success[500] + '50',
  },
  requestHeader: {
    flexDirection: 'row',
    justifyContent: 'space-between',
