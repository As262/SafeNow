...
const UserDashboard = () => {
  ...
  const cachedHelperRequests = useRef({
    pending: [],
    accepted: [],
    timestamp: 0,
  });
  ...
  const loadHelperRequestsOptimized = useCallback(
    async (skipCache = false) => {
      ...
      if (
        !skipCache &&
        now - cachedHelperRequests.current.timestamp < CACHE_DURATION
      ) {
                                ...
                                <button
                                  onClick={async (e) => {
                                    ...
                                    try {
                                      ...
                                      setSuccessMessage(
                                        "Help confirmed! Thank you for your feedback.",
                                      );
                                      setTimeout(
                                        () => setSuccessMessage(""),
                                        5000,
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={helperRadius}
                        onChange={(e) =>
                          setHelperRadius(parseInt(e.target.value))
                        }
                        className="w-full"
                      />
                    </div>
              ...
              {isHelper && helperAvailable && (
                <div className="card p-8">
                  ...
                  {helperLoading ? (
                    ...
                    <div className="space-y-4">
                      {helperRequests
                        .filter((req) => req.userId !== user.mobile)
                        .map((req) => (
                          <div
                            key={req.id}
                              ...
                              <div className="flex flex-col gap-2">
                                <button
                                  onClick={async (e) => {
                                    ...
                                    setSuccessMessage(
                                      "Request accepted! User has been notified.",
                                    );
                                    setTimeout(
                                      () => setSuccessMessage(""),
                                      3000,
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="bg-white rounded-lg p-4 border-2 border-gray-200">
                  <p className="text-gray-700 text-sm leading-relaxed">
                    ...
                    read this Volunteer Helper Consent Agreement carefully
                    before proceeding. By clicking "I Accept and Consent" below,
                    you acknowledge that you have read, understood, and agree to
                    be bound by all terms and conditions outlined in this
                    document.
                  </p>
                </div>
                  ...
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="space-y-2 text-sm text-gray-700">
                        <p>
                          <strong>1.1.</strong> I understand that I am
                          registering as a <strong>volunteer helper</strong> and
                          not as a certified emergency responder, employee, or
                          agent of SafeNow.
                        </p>
                        <p>
                          <strong>1.2.</strong> I agree to respond to emergency
                          requests{" "}
                          <strong>
                            only when I am genuinely available and capable
                          </strong>{" "}
                          of providing safe assistance.
                        </p>
                        <p>
                          <strong>1.3.</strong> I will{" "}
                          <strong>
                            provide assistance in a safe, responsible, and
                            lawful manner
                          </strong>
                          , respecting the privacy and dignity of those I help.
                        </p>
                        <p>
                          <strong>1.4.</strong> I will{" "}
                          <strong>
                        ...
                        <p>
                          <strong>1.5.</strong> I acknowledge that I must{" "}
                          <strong>never put myself or others in danger</strong>{" "}
                ...
                <div className="bg-white rounded-lg p-4 border border-gray-300">
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="space-y-2 text-sm text-gray-700">
                        <p>
                          <strong>2.1.</strong> I understand that SafeNow is a{" "}
                          <strong>
                            platform to connect volunteers with those in need
                          </strong>{" "}
                          and does not verify helper qualifications,
                          credentials, or training.
                        </p>
                        <p>
                          <strong>2.2.</strong> I acknowledge that{" "}
                          <strong>
                            SafeNow, its owners, operators, and affiliates are
                            not liable
                          </strong>{" "}
                          for any incidents, injuries, damages, losses, or
                          claims that may occur during or as a result of my
                          volunteer activities.
                        </p>
                        <p>
                          <strong>2.3.</strong> I agree to{" "}
                          <strong>indemnify and hold harmless SafeNow</strong>{" "}
                          from any claims, damages, or liabilities arising from
                          my actions as a volunteer helper.
                        </p>
                        <p>
                          <strong>2.4.</strong> I understand that I am{" "}
                          <strong>
                            solely responsible for my own safety, actions, and
                            decisions
                          </strong>{" "}
                          while providing assistance.
                        </p>
                        <p>
                          <strong>2.5.</strong> I acknowledge that{" "}
                          <strong>
                            professional emergency services (police, fire,
                            ambulance) should always be contacted
                          </strong>{" "}
                ...
                <div className="bg-white rounded-lg p-4 border border-gray-300">
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="space-y-2 text-sm text-gray-700">
                        <p>
                          <strong>3.1.</strong> I consent to having my{" "}
                          <strong>name and approximate location shared</strong>{" "}
                          with users I choose to help.
                        </p>
                        <p>
                          <strong>3.2.</strong> I understand that my{" "}
                          <strong>contact information may be visible</strong> to
                          users whose emergency requests I accept.
                        </p>
                        <p>
                          <strong>3.3.</strong> I acknowledge that my{" "}
                          <strong>
                            helper activity, responses, and interactions will be
                            recorded
                          </strong>{" "}
                          by SafeNow for safety, quality, and legal purposes.
                        </p>
                        <p>
                          <strong>3.4.</strong> I understand that I can{" "}
                          <strong>disable helper mode at any time</strong> to
                          stop receiving emergency requests.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-lg p-4 border border-gray-300">
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="space-y-2 text-sm text-gray-700">
                        <p>
                          <strong>4.1.</strong> I understand that{" "}
                          <strong>
                            volunteering as a helper involves inherent risks
                          </strong>
                          , including but not limited to physical injury,
                          emotional distress, property damage, or exposure to
                          dangerous situations.
                        </p>
                        <p>
                          <strong>4.2.</strong> I{" "}
                          <strong>voluntarily assume all risks</strong>{" "}
                          associated with my activities as a helper on the
                          SafeNow platform.
                        </p>
                        <p>
                          <strong>4.3.</strong> I confirm that I am{" "}
                          <strong>physically and mentally capable</strong> of
                          providing the type of assistance I intend to offer.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-red-800 leading-relaxed">
                        By accepting this consent form, I certify that I have
                        carefully read and fully understand all terms and
                        conditions outlined above. I voluntarily agree to
                        participate as a helper, acknowledge all risks involved,
                        and release SafeNow from any and all liability. I
                        confirm that I am at least 18 years of age and legally
                ...
                <label className="flex items-start gap-3 cursor-pointer group">
                  ...
                  <span className="text-sm text-gray-700 group-hover:text-gray-900">
                    <strong className="text-gray-900">
                      I have read and understood the entire Volunteer Helper
                      Consent Agreement.
                    </strong>{" "}
                    I voluntarily agree to all terms and conditions and consent
                    to becoming a volunteer helper on the SafeNow platform.
                  </span>
                </label>
              </div>
          ...
          <div className="bg-dark-800 rounded-lg shadow-xl p-6 max-w-md w-full border border-dark-700">
            ...
            <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-3 mb-4">
              <p className="text-xs text-yellow-200">
                ...
                24-48 hours. Funds will be transferred to your registered bank
                account.
              </p>
            </div>
